<?php
     ...
     if($_SERVER["REQUEST_METHOD"]=="POST") 
     {
     	...
     	if(empty($_POST["variation"])) {
     		...
     		$err_variation = "<br> Choose a variation Required";
     	}
     	else{
     	...
     	if(empty($_POST["spicylevel"])) {
     		...
     		$err_spicylevel = " <br> Spicy Level Required";
     	}
     	else{
...
<head>
	...
	<title>Pizza Show Details</title>
	<style>
        ...
        Choose a variation
          ...
          <tr> 
                <td> <span>Variation</span> </td>
                    <td>
                        :<br><input type="radio" name="variation" value="eight"><span> 8 inchi</span> <br>
                        <input type="radio" name="variation" value="twelve"><span> 12 inchi</span> <br>
                        <input type="radio" name="variation" value="sixteen"><span> 16 inchi</span> 
                         <span><?php echo $err_variation;?></span>
                    </td>

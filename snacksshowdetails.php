...
<head>
	...
	<title>Snacks Show Details</title>
	<style>
        ...
        Choice 
          ...
          <tr> 
                <td> <span>Choice </span> </td>
                    <td>
                        :<br><input type="radio" name="choice" value="medium"><span> Medium</span> <br>
                        <input type="radio" name="choice" value="large"><span> Large</span> 
                        
                         <span><?php echo $err_choice;?></span>
                    </td>
